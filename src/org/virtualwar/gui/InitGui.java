...
public class InitGui {
	...
	public static String getLangFromUser(){
		...
		panel.add(lbl);
		panel.add(boxLang);
		int selectedOption = JOptionPane.showOptionDialog(null, panel, "Select your language", JOptionPane.NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options , options[0]);
